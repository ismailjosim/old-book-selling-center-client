...
const Dashboard = () => {
    ...
    return (
        <div>
            <h2 className='text-3xl font-semibold text-center mb-5'>Welcome <span className='text-primary font-bold'>{user.displayName}</span> <br /> to Your Dashboard</h2>
                ...
                <div className="max-w-md p-8 sm:flex sm:space-x-6 bg-slate-100 rounded-md shadow-md text-black">
                    ...
                    <div className="flex flex-col space-y-4 justify-center">
                        ...
                        <div className="flex justify-center pt-2 space-x-4 align-center">
                            <button className="p-3 rounded-full bg-primary text-white hover:bg-secondary hover:text-primary">
